...
\texttt{decimal\_fast32\_t} & 481,455 & 11.960 \\
\texttt{decimal\_fast64\_t} & 465,461 & 11.563 \\
\hline
\end{tabular}
...
One reason that we have heard from a user in the financial sector is that they are using \code{decimal64\_t} instead of \code{decimal\_fast64\_t} in production because it allows them to easier memcpy the value into a \code{std::uint64\_t} and transmit. 
