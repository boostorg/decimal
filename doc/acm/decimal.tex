...
The above example is depicted in the DPD format which is typically for hardware implementation.
For the remainder of this paper we will focus on the BID format as it is more natural for software implementations like ours.
