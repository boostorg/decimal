...
- `BOOST_DECIMAL_CONSTEXPR`: This is defined to `constexpr` when any of the following are met, or `BOOST_DECIMAL_NO_CONSTEVAL_DETECTION` is when they are not met :
  * pass:[_MSC_FULL_VER] >= 192528326
  * pass:[__GNUC__] >= 9
