...
constexpr detail::uint128_t to_bid_d128(decimal128_t val) noexcept;

constexpr decimal128_t from_bid_d128(detail::uint128_t bits) noexcept;
...
constexpr T from_bid(detail::uint128_t bits) noexcept;
...
constexpr detail::uint128_t to_dpd_d128(decimal128_t val) noexcept;

constexpr detail::uint128_t to_dpd_d128f(decimal_fast128_t val) noexcept;
...
template <typename T = decimal128_t>
constexpr T from_dpd(detail::uint128_t bits) noexcept;
