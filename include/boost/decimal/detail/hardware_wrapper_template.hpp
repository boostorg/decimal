...
template <>
inline decimal128_t_components decode_bits<false>(const int128::uint128_t bits)
{
    decimal128_t_components::significand_type significand {};
    decimal128_t_components::biased_exponent_type expval {};

    if ((bits.high & d128_combination_field_mask) == d128_combination_field_mask)
    {
        ...
        expval = (bits.high & d128_11_exp_mask) >> d128_11_exp_high_word_shift;
    }
    else
    {
        significand = bits & d128_not_11_significand_mask;
        expval = (bits.high & d128_not_11_exp_mask) >> d128_not_11_exp_high_word_shift;
    }

    const auto sign {static_cast<bool>(bits.high & d128_sign_mask)};

    return decimal128_t_components {significand, expval - detail::bias_v<decimal128_t>, sign};
}

template <>
inline decimal128_t_components decode_bits<true>(const int128::uint128_t bits)
{
