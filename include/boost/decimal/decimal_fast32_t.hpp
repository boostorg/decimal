...
template <>
class numeric_limits_impl<boost::decimal::decimal_fast32_t>
{
public:
...
constexpr bool numeric_limits_impl<decimal_fast32_t>::is_specialized;
constexpr bool numeric_limits_impl<decimal_fast32_t>::is_signed;
constexpr bool numeric_limits_impl<decimal_fast32_t>::is_integer;
constexpr bool numeric_limits_impl<decimal_fast32_t>::is_exact;
constexpr bool numeric_limits_impl<decimal_fast32_t>::has_infinity;
constexpr bool numeric_limits_impl<decimal_fast32_t>::has_quiet_NaN;
constexpr bool numeric_limits_impl<decimal_fast32_t>::has_signaling_NaN;

// These members were deprecated in C++23
#if ((!defined(_MSC_VER) && (__cplusplus <= 202002L)) || (defined(_MSC_VER) && (_MSVC_LANG <= 202002L)))
constexpr std::float_denorm_style numeric_limits_impl<decimal_fast32_t>::has_denorm;
constexpr bool numeric_limits_impl<decimal_fast32_t>::has_denorm_loss;
#endif

constexpr std::float_round_style numeric_limits_impl<decimal_fast32_t>::round_style;
constexpr bool numeric_limits_impl<decimal_fast32_t>::is_iec559;
constexpr bool numeric_limits_impl<decimal_fast32_t>::is_bounded;
constexpr bool numeric_limits_impl<decimal_fast32_t>::is_modulo;
constexpr int numeric_limits_impl<decimal_fast32_t>::digits;
constexpr int numeric_limits_impl<decimal_fast32_t>::digits10;
constexpr int numeric_limits_impl<decimal_fast32_t>::max_digits10;
constexpr int numeric_limits_impl<decimal_fast32_t>::radix;
constexpr int numeric_limits_impl<decimal_fast32_t>::min_exponent;
constexpr int numeric_limits_impl<decimal_fast32_t>::min_exponent10;
constexpr int numeric_limits_impl<decimal_fast32_t>::max_exponent;
constexpr int numeric_limits_impl<decimal_fast32_t>::max_exponent10;
constexpr bool numeric_limits_impl<decimal_fast32_t>::traps;
constexpr bool numeric_limits_impl<decimal_fast32_t>::tinyness_before;
...
class numeric_limits<boost::decimal::decimal_fast32_t> :
    public boost::decimal::detail::numeric_limits_impl<boost::decimal::decimal_fast32_t> {};
